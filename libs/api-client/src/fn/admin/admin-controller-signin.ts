...
export function adminControllerSignin(http: HttpClient, rootUrl: string, params: AdminControllerSignin$Params, context?: HttpContext): Observable<StrictHttpResponse<TokensDto>> {
...
adminControllerSignin.PATH = '/api/admin/signin';
